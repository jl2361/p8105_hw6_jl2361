...
The odds of solving homicides in male victims compared to female victims may be lower in a number of cities (mostly cities depicted on the right side of this plot- for instance, New York, NY, Baton Rouge, LA, Omaha, NE) keeping all other variables fixed. We can see that the CIs for these cities do not cross 1 although not universally. It is worth noting that in the cities that appear to have estimated ORs greater than 1, the CIs all cross 1 so the observed effect is not significant (e.g. Albuquerque, NM, Stockton, CA, Fresno, CA) 
