...
A plot of model residuals against fitted values can help us assess for linearity, homoskedasticity, and outliers. We see some issues with our model. Linearly looks OK, though homoskedasticity appears to be violated. There are also several outliers. We note these issues for now.
```{r}
proposed_model =
